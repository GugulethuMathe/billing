...
class BillCycleConfig extends Model
{
	protected $DBGroup              = 'default';
	protected $table                = 'bill_cycle_config';
	...
	public function getRate()
    {
	  ...
	  public function getRatesById($id)
	  {
		  ...
		  $sql = "select * from bill_cycle_config where id=$id";
		  return $this->db->query($sql)->getResult();
	  }
	  public function updateUser($newData, $id)
	  {
		  $query = $this->db->table('bill_cycle_config')->update($newData, array('id ' => $id));
		  return $query;
	  }
